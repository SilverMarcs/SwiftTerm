...
//        scroller.target = self
    ...
    {
        return NSRect (x: 0, y: 0, width: cellDimension.width * CGFloat(terminal.cols) + reservedScrollerWidth + contentInsets.left + contentInsets.right, height: cellDimension.height * CGFloat(terminal.rows) + contentInsets.top + contentInsets.bottom)
    }
